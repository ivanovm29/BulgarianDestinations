...
{
    [TestFixture]
    public class SearchWithZeroTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "SearchWithZeroTestInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_SearchWithZeroTest()
        {
            var searchedDestinations = service.SearchAsync(null, null, 1, 5).Result;

...
{
    [TestFixture]
    public class GetHundredPercentBulgarianTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "GetHundredPercentBulgarianTestInMemoryDb") // Give a Unique name to the DB
                    .Options;

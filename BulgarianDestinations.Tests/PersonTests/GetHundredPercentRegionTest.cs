...
{
    [TestFixture]
    public class GetHundredPercentRegionTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "GetHundredPercentRegionTestInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_GetHundredPercentRegionTest()
        {

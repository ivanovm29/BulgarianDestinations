...
{
    [TestFixture]
    public class GetOutDestinationTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "GetOutDestinationTestInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_GetOutDestinationTest()
        {
            personService.GetDestination(1, 1);
            personService.GetOutDestination(1, 1);

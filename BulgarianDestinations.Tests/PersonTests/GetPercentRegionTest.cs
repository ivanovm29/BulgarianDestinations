...
{
    [TestFixture]
    public class GetPercentRegionTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "GetPercentRegionTestInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_GetPercentRegionTest()
        {
            personService.GetDestination(3, 1);
            personService.GetDestination(2, 1);
            personService.GetDestination(5, 1);


            int actualPercent = personService.GetPercentRegion(1 , 1).Result;
            int expectedPercent = 66;

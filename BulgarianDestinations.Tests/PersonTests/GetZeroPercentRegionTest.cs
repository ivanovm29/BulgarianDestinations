...
{
    [TestFixture]
    public class GetZeroPercentRegionTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "GetZeroPercentRegionTestInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_GetZeroPercentRegionTest()
        {

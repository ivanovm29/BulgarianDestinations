...
{
    [TestFixture]
    public class RemoveArticulFromCart
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "RemoveArticulFromCartInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_RemoveArticulFromCart()
        {
            service.RemoveArticul(2, 1);

            int actualCount = repository.AllReadOnly<ArticulPerson>().Count();
            int expectedCount = 3;         

    ...
    public class GetAllTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "GetAllArticulsInCartInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_GetAllArticulsInCart()
        {
            var carts = service.All();
            int expectedCount = 2;
            int actualCount = carts.Result.Where(c => c.PersonId == 1).Count();

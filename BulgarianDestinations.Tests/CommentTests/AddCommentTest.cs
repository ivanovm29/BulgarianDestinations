    ...
    public class AddCommentTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "AddCommentTestInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_AddCommentTest()
        {
            ...
            var actualText = repository.AllReadOnly<Comment>().FirstOrDefault(c => c.Id == 1).Text; ;

            var expectedText = "Test test test.";
            var expectedFirstName = "Marian";
            var expectedLastName = "Ivanov";

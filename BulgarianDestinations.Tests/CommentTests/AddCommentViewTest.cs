...
{
    [TestFixture]
    public class AddCommentViewTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "AddCommentViewTestInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_AddCommentViewTest()
        {
            var commentView = service.Add(1, 2).Result;

            int actualDestinationId = commentView.DestinationId;
            int actualPersonId = commentView.PersonId;

            int expectedDestinationId = 1;
            int expectedPersonId = 2;

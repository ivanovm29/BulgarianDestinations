    ...
    public class DeleteOrderTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "DeleteOrderTestInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        [Test]
        public void Test_DeleteOrderTest()
        {

            service.DeleteOrder(1);

            int actualOrdersCount = repository.AllReadOnly<Order>().Count();

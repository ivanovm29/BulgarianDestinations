...
{
    [TestFixture]
    public class DeleteArticulTest
    {
        ...
        public void TestInitialize()
        {
            ...
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                    .UseInMemoryDatabase(databaseName: "DeleteArticlulInMemoryDb") // Give a Unique name to the DB
                    .Options;
        ...
        public void Test_DeleteArticul()
        {
            ...
            service.DeleteArticul(2);

            int count = repository.AllReadOnly<Articul>().Count();

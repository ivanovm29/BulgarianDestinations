...
namespace BulgarianDestinations.Infrastructure.Data.Models.SeedDb
{
    internal class SeedData : SeedDestination
    {
        ...
        private void SeedDestinations()
        {
            ...
            BelogradchikRocks = new Destination()
            {
                Id = 15,
            ...
            SevenRilaLakes = new Destination()
            {
                Id = 26,
            ...
            StobskiPiramids = new Destination()
            {
                Id = 28,
            ...
            KrushenskiWaterfall = new Destination()
            {
                Id = 29,
            ...
            DevetashkaCave = new Destination()
            {
                Id = 30,
            ...
            MuseumMinnoDelo = new Destination()
            {
                Id = 36,
            ...
            PanoramaPleven = new Destination()
            {
                Id = 39,
            ...
            PlovdivStarGrad = new Destination()
            {
                Id = 41,
            ...
            AsenovaKrepost = new Destination()
            {
                Id = 42,
            ...
            StatujaSvoboda = new Destination()
            {
                Id = 48,
            ...
            ChudniteMostove = new Destination()
            {
                Id = 52,
            ...
            DiavolskoGurlo = new Destination()
            {
                Id = 53,
            ...
            SvAleksandarNevski = new Destination()
            {
                Id = 55,
            ...
            ManastirSedemtePrestola = new Destination()
            {
                Id = 60,
            ...
            Kazanlak = new Destination()
            {
                Id = 62,
                Name = "Казанлък - музей на розата",
                Description = "Розопроизводството, и в още по-голяма степен търговията с розово масло се превръщат в една от най-атрактивните “визитни картички” на казанлъшкия край и на българското стопанство. Още от преди близо век основателно се твърди, че “розовата култура в България, целяща извличане на розовото масло, не е само най-старата и най-привлекателната индустрия в нашата страна, но също съвсем изключителна и специфична за региона.”\r\nВ град Казанлък, се намира единствения по рода си Музей на розата. Първата музейна експозиция за казанлъшката роза е открита през 1967 г., а през 1969 г. тя прераства в Музей на розата, който е уникален в световен мащаб. От 2016 г. той се помещава в нова сграда в парк “Розариум” и е част от Историческия музей “Искра” в гр. Казанлък.\r\nМузеят на розата има богата колекция от предмети, снимки и документи, разкриващи\r\nисторията на българското производство на маслодайни рози. Експонатите са разположени в три пространства. В музея могат да се видят и инструменти за обработка на розови градини, съдове за съхранение и износ на розово масло и вода. Направена е и възстановка на склад за розово масло и на първата лаборатория за изследване на чистотата на розовото масло, създадена през 1907 г. от Христо Яръмов. Това е свързано с тежък момент в историята на българското розопроизводство, когато се появява т.нар. „тереше” – фалшификат на истинското розово масло. Под заплахата от сриване на репутацията на българското розово масло като най-доброто в света, лабораторията на Христо Яръмов се явява успешен опит за осуетяване на тази вредна практика.\r\nЗабележителен предмет в експозицията на музея е съд за розово масло (конкума), който е бил използван за последен път през 1947 г., но ароматът на рози се носи все още от него.\r\nВ музея туристите имат възможност да закупят розово масло, различни продукти на маслодайната роза, козметика, розов ликьор и сувенири, свързани с бита и културата на розопроизводителите.",
                ImageUrl = "https://i.ibb.co/NW8xJbL/Kazanlak.jpg",
                RegionId = 24

            };
            MogilaGoljamaKosmatka = new Destination()
            {
                Id = 63,
            ...
            Pametnik1300Bulgaria = new Destination()
            {
                Id = 68,
            ...
            MadarskiKonnik = new Destination()
            {
                Id = 69,
